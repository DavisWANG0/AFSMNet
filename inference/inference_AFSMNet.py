...
from basicsr.archs.AFSMNet_arch import AFSMNet
...
def main(args):
    ...
    torch.cuda.set_device(2)      # set GPU ID
    ...
    model = AFSMNet(dim=36, n_blocks=16, branch_ratio=0.25, upscaling_factor=4)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='AFSMNetx4', help='method name')
    parser.add_argument('--lr_path', type=str, default='datasets/demo', help='Path to the LR image')
    ...
    parser.add_argument('--save_path', type=str, default='visual_results/demo/', help='Path to results')
    parser.add_argument('--pretrain_model', type=str, default='experiments/icassp_wuchenx4_0902_v2/models/net_g_200000.pth', help='Path to the pretrained model')
