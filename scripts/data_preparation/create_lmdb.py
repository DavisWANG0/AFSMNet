...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = 'datasets/DIV2K/DIV2K_train_HR'
    lmdb_path = 'datasets/DIV2K/DIV2K_train_HR.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = 'datasets/DIV2K/DIV2K_train_LR_bicubic/X2'
    lmdb_path = 'datasets/DIV2K/DIV2K_train_LR_bicubic_X2.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = 'datasets/DIV2K/DIV2K_train_LR_bicubic/X3'
    lmdb_path = 'datasets/DIV2K/DIV2K_train_LR_bicubic_X3.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    folder_path = 'datasets/DIV2K/DIV2K_train_LR_bicubic/X4'
    lmdb_path = 'datasets/DIV2K/DIV2K_train_LR_bicubic_X4.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
def create_lmdb_for_df2k_sub():
    ...
    # lmdb_path = 'datasets/DF2K/DF2K_train_LR_bicubic/X4_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    
    folder_path = 'datasets/DF2K/DF2K_train_LR_bicubic/X3'
    lmdb_path = 'datasets/DF2K/DF2K_train_LR_bicubic/X3.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
if __name__ == '__main__':
    ...
    elif dataset == 'df2k_sub':
        create_lmdb_for_df2k_sub()
    elif dataset == 'reds':
